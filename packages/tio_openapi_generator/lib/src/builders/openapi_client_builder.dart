...
class TioOpenApiClientBuilder extends Builder {
  TioOpenApiClientBuilder({required this.componentsGenerators})
      : buildExtensions = {
          _inputPattern: [
            ...componentsGenerators.map(
              (e) => _outputPattern.replaceFirst(_placeholder, e.suffix),
            ),
          ],
        };
